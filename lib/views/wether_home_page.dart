        ...
        children: [
          ...
          Center(
            child: ElevatedButton.icon(
              onPressed: () => viewModel.fetchWeather(viewModel.cityController.text),
          ...
          if (viewModel.isLoading)
            ...
            GridView.count(
              ...
              mainAxisSpacing: 12,
              children: const [
                InfoGridTile(title: 'Sunrise', icon: Icons.wb_sunny, value: '6:15 AM'),
                InfoGridTile(title: 'Sunset', icon: Icons.nightlight_round, value: '6:45 PM'),
                InfoGridTile(title: 'Feels Like', icon: Icons.thermostat, value: '28°C'),
                InfoGridTile(title: 'Visibility', icon: Icons.remove_red_eye, value: '6 km'),
              ],
            ),
          ]
